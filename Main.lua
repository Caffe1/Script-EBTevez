-- script feito por CAFFE e OIILUKAZ --
 -- 13/07/2024 --
      ...
      Tab:AddLabel("Não Fucionou?")
      Tab:AddLabel("Feche A Gui Fly Riding")
      Tab:AddLabel("é abra novamente ou reseta roblox")
      
      PLTab:AddButton({
            Name = "Voar Com Carro (apenas)",
          Callback = function()
